...
import { CheckCircle2, Copy, ArrowRight, Phone } from 'lucide-react';
      ...
      >
        ...
        <div className="bg-surface-alt border border-gray-200 rounded-xl p-6 mb-8 inline-block mx-auto">
          ...
          <div className="flex items-center justify-center gap-3">
            <span className="text-[22px] md:text-[26px] font-heading font-bold text-primary tracking-wider">
              {referenceNumber}
            </span>
            <button
              onClick={handleCopy}
            ...
            >
              {copied ? (
                ...
                <Copy
                  size={18}
                  className="text-gray-400 group-hover:text-foreground"
                />
              )}
            </button>
          </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 mb-8 text-left">
          <h4 className="text-[15px] font-bold text-foreground mb-4">
            What happens next?
          </h4>
          <div className="space-y-4">
            {[
              {
                step: '1',
                text: 'Our team will review your enquiry and contact you shortly.',
              },
              {
                step: '2',
                text: 'We will share relevant project information based on your interest.',
              },
              {
                step: '3',
                text: 'If applicable, we will facilitate next-step discussions with stakeholders.',
              },
            ].map((item) => (
        ...
        <p className="text-[11px] text-gray-400 mb-8 leading-relaxed">
          This submission does not constitute a commitment, guarantee of
          investment returns, project allocation, or promise of specific
          development outcomes. Trinfra facilitates connections and processes on
          a best-effort basis.
        </p>
