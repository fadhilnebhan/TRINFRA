...
export default function SellerRegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fafaf9] flex flex-col justify-center py-12 sm:px-6 lg:px-8 pt-24 pb-16">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        ...
        <h1 className="text-2xl font-black text-gray-900 tracking-tight">Create Seller Account</h1>
      ...
      <div className="mt-6 sm:mx-auto sm:w-full sm:max-w-md px-4 sm:px-0">
        <div className="bg-white py-8 px-6 sm:px-10 rounded-2xl border border-gray-100 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-3.5 py-2 text-xs sm:text-sm bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary"
                />
              </div>
            </div>
            ...
            <div>
              <label className="block text-xs font-semibold text-gray-700 mb-1">Company / Agency Name (Optional)</label>
              <div className="relative">
            ...
            <div className="flex items-start gap-2 pt-1">
              ...
              <label htmlFor="terms" className="text-xs text-gray-500">
                I agree to the TRINFRA Marketplace Terms and consent to listing moderation review.
              </label>
            </div>
